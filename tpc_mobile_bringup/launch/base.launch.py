...
def generate_launch_description():
  bringup_dir = os.path.join(
    get_package_share_directory('tpc_mobile_bringup'),
    'launch'
  )
  ...
  robot_description = Command(
        [
            ...
            PathJoinSubstitution(
                [
                    FindPackageShare('tpc_mobile_description'),
                    'urdf',
  ...
  diff_drive_cvontroller_spwaner = Node(
    package='controller_manager',
    executable='spawner',
  ...
  delay_rviz_after_joint_state_broadcaser_spawner = RegisterEventHandler(
  ...
  delay_diff_drive_controller_spawner_after_joint_state_broadcaster_spawner = RegisterEventHandler(
    event_handler=OnProcessExit(
      target_action=joint_state_broadcaster_spawner,
      on_exit=[diff_drive_cvontroller_spwaner]
    )
  )

  delay_imu_broadcasster_spawner_after_joint_state_broadcaster_spawner = RegisterEventHandler(
    event_handler=OnProcessExit(
      target_action=joint_state_broadcaster_spawner,
  ...
  odom_pub_node = Node(
    package="odometry_pub_node",
    executable="odometry_pub_node",
    name="odom_pub_node",
    output = "screen"
  )
  ...
  static_base_tf_node = Node(
    ...
    name="static_basefootfrint_to_baselink_tf",
  ...
  robot_localization_launch = IncludeLaunchDescription(
    PythonLaunchDescriptionSource([os.path.join(
      get_package_share_directory('tpc_robot_localization'),'launch'
    ), '/ekf.launch.py']),
  )

  teleop_launch = IncludeLaunchDescription(
    PythonLaunchDescriptionSource([os.path.join(
      get_package_share_directory('tpc_mobile_joy_teleop'),'launch'
    ),'/tpc_mobile_joy_teleop.launch.py']),
  )
  ...
  nodes = [
    ...
    delay_rviz_after_joint_state_broadcaser_spawner,
    delay_diff_drive_controller_spawner_after_joint_state_broadcaster_spawner,
    robot_localization_launch,
    teleop_launch,
    #static_base_tf_node,
    #delay_imu_broadcasster_spawner_after_joint_state_broadcaster_spawner,
    #odom_pub_node,
  ]
