...
# turtlebot3_manipulation_cartographer package from ROBOTIS, adapted to implement
# tpc_mobile_robot cartographer package.
...
def generate_launch_description():
    ...
    cartographer_config_dir = PathJoinSubstitution(
        [
            FindPackageShare('tpc_mobile_robot_cartographer'),
            'config',
        ]
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            default_value='tpcmobile_2d.lua',
